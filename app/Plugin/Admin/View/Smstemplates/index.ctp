...
?>
<div id="resultDiv"> 
<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('SMS Templates');?></h1></div></div>
<div class="panel">
<?php echo $this->Session->flash();?>
    <div class="panel-heading">
	<div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'Smstemplates'));?>
	    <?php if($userPermissionArr['save_right']){ echo $this->Html->link('<span class="fa fa-plus"></span>&nbsp;'.__('Add New SMS Template'),array('controller'=>'Smstemplates','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));}?>
...
<div class="panel-body">
			    ...
			    <td><span class="label label-<?php if($post['Smstemplate']['status']=="Published")echo"success";else echo"danger";?>"><?php echo __($post['Smstemplate']['status']); ?></span></td>
			    ...
			    <?php if($userPermissionArr['update_right']){?><li><?php echo $this->Html->link('<span class="fa fa-edit"></span>&nbsp;'.__('Edit'),'javascript:void(0);',array('name'=>'editallfrm','onclick'=>"check_perform_sedit('$url','$id');",'escape'=>false));?></li><?php }?>
                            <?php if($userPermissionArr['delete_right']){ if($post['Smstemplate']['type']==null){?><li><?php echo $this->Html->Link('<span class="fa fa-trash"></span>&nbsp;'.__('Delete'),'javascript:void(0);',array('onclick'=>"check_perform_sdelete('$id');",'escape'=>false));?></li><?php }}?>
			    </ul>
			  </div></td><?php }?>
                        </tr>
                        <?php endforeach;?>
