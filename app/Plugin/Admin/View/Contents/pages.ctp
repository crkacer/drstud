...
<?php echo $this->Session->flash();?>
	...
	<div class="btn-group">
            <?php $url=str_replace("/pages","",$this->Html->url(array('controller'=>'Contents')));if($userPermissionArr['save_right']){ echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;'.__('Add New Page'),array('controller'=>'Contents','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));}?>
