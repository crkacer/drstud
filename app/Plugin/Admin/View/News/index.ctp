...
<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('News');?></h1></div></div>
<div class="panel"><?php echo $this->Session->flash();?>
    <div class="panel-heading">
        <div class="btn-group">
            <?php $url=$this->Html->url(array('controller'=>'News')); if($userPermissionArr['save_right']){ echo $this->Html->link('<span class="fa fa-plus-circle"></span>&nbsp;'.__('Add New News'),array('controller'=>'News','action'=>'add'),array('escape'=>false,'class'=>'btn btn-success'));}?>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('news_title', __('News Title'), array('direction' => 'asc'));?></th>
                        ...
                        $id=$post['News']['id'];?>
                        <tr>
                            <td><?php echo $this->Form->checkbox(false,array('value' => $post['News']['id'],'name'=>'data[News][id][]','id'=>"DeleteCheckbox$id",'class'=>'chkselect'));?></td>
                            <td><?php echo $serial_no++; ?></td>
                            <td><?php echo h($post['News']['news_title']); ?></td>
                            <td><span class="label label-<?php if($post['News']['status']=="Active")echo"success";else echo"danger";?>"><?php echo __($post['News']['status']); ?></span></td>
