							...
							foreach ($vocahw as $value) { ?>
								<div class="exam-heading"><?php echo __("Question");?></div>
									<div class="panel panel-default">
												...
												<tr>
													<td>
														<h4>
															...
															<div class="pull-right mrg-left mrg-right"><strong><?php echo __('Correct Marks');?>: <span class="text-success"><?php echo $value['VocaHwQuestion']['marks'];?></span> , <?php echo __('Negative Marks');?>: <span class="text-danger"><?php echo $value['VocaHwQuestion']['negative_marks'];?></span></strong></div>
														</h4>
													</td>
												</tr>
												<tr>
													<td>
														<div class="question_box">
															<div class="mrg-left">
																...
																<strong><?php echo str_replace("<script","",$value['VocaHwQuestion']['question']);?></strong>
															</div>
														</div>
													</td>
												</tr>
												</thead>
												<?php if(strlen($value['VocaHwQuestion']['hint'])>0){?>
												<tr>
													<td><div class="mrg-left"><strong><?php echo __('Hint');?> : </strong><?php echo str_replace("<script","",$value['VocaHwQuestion']['hint']);?></div></td>
												</tr>
												<?php } ?>
											</table>
											<!---- ANSWER SECTION --------->
										...
										$i = 1;
										do  {
											if ($value["VocaHwQuestion"]["option".$i] != "")
											$option_array[$i] =  $value["VocaHwQuestion"]["option".$i];
											$i ++;
										}while($i < 7);
										...
										<tr>
											<td>								
												<?php if(strlen($value['VocaHwQuestion']['answer'])>1)
												{
