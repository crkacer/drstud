									...
									<div class="panel panel-default">
										<div class="table-responsive exam-panel">
											<table class="table">
												...
												<tr>
													<td>
														<h4>
															...
															<div class="pull-right mrg-left mrg-right"><strong><?php echo __('Correct Marks');?>: <span class="text-success"><?php echo $value['PhonicPracticeQs']['marks'];?></span> , <?php echo __('Negative Marks');?>: <span class="text-danger"><?php echo $value['PhonicPracticeQs']['negative_marks'];?></span></strong></div>
														</h4>
													</td>
												</tr>
												<tr>
												...
												<?php if(strlen($value['PhonicPracticeQs']['hint'])>0){?>
												<tr>
													<td><div class="mrg-left"><strong><?php echo __('Hint');?> : </strong><?php echo str_replace("<script","",$value['PhonicPracticeQs']['hint']);?></div></td>
												</tr>
												<?php } ?>
										...
										$i = 1;
										do  {
											if ($value["PhonicPracticeQs"]["option".$i] != "")
											$option_array[$i] =  $value["PhonicPracticeQs"]["option".$i];
											$i ++;
										}while($i < 7);
										...
										<tr>
											<td>								
												<?php if(strlen($value['PhonicPracticeQs']['answer'])>1)
												{
