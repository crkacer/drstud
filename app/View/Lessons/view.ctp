<?php $quizUrl=$this->Html->url(array('action'=>"quiz/$lessonId"));?>
<div class="container">
			...
			<div class="table-responsive">
				<table class="table">
					<tr>
						...
						<td><strong class="text-success"><?php if($post['Exam']['type']=="Exam") echo __('Quiz');else echo __($post['Exam']['type']);?></strong></td>
					</tr>
					<tr>
				...
				<tr>
				<td colspan="4">
				<?php echo $this->Html->link('<span class="fa fa-sign-in"></span> '.__('Attempt Now'),array('controller'=>'Exams','action'=>'guidelines',$id),array('data-toggle'=>'tooltip','title'=>__('Attempt Now'),'escape'=>false,'target'=>'_blank','class'=>'btn btn-success'));?>&nbsp;&nbsp;<?php echo $this->Html->link('<span class="fa fa-arrow-left"></span>'.__('Back'),'javascript:void(0);',array('data-toggle'=>'tooltip','title'=>__('Back'),'onclick'=>"show_modal('$quizUrl');",'escape'=>false,'class'=>'btn btn-warning'));?>
				</td>
				</tr>
				</table>
			</div>
