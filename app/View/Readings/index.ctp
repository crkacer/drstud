							...
							foreach ($vocahw as $value) { ?>
								<div class="exam-heading"><?php echo __("Question");?></div>
									<div class="panel panel-default">
												...
												<tr>
													<td>
														<h4>
															...
															<div class="pull-right mrg-left mrg-right"><strong><?php echo __('Correct Marks');?>: <span class="text-success"><?php echo $value['ReadingPracticeQs']['marks'];?></span> , <?php echo __('Negative Marks');?>: <span class="text-danger"><?php echo $value['ReadingPracticeQs']['negative_marks'];?></span></strong></div>
														</h4>
													</td>
												</tr>
												<tr>
													<td>
														<div class="question_box">
															<div class="mrg-left">
																...
																<strong><?php echo str_replace("<script","",$value['ReadingPracticeQs']['question']);?></strong>
															</div>
														</div>
													</td>
												</tr>
												</thead>
												<?php if(strlen($value['ReadingPracticeQs']['hint'])>0){?>
												<tr>
													<td><div class="mrg-left"><strong><?php echo __('Hint');?> : </strong><?php echo str_replace("<script","",$value['ReadingPracticeQs']['hint']);?></div></td>
												</tr>
												<?php } ?>
											</table>
											<!---- ANSWER SECTION --------->
										...
										$i = 1;
										do  {
											if ($value["ReadingPracticeQs"]["option".$i] != "")
											$option_array[$i] =  $value["ReadingPracticeQs"]["option".$i];
											$i ++;
										}while($i < 7);
										...
										<tr>
											<td>								
												<?php if(strlen($value['ReadingPracticeQs']['answer'])>1)
												{
