...
class TinymceHelper extends AppHelper { 
    ...
    */ 
    function input($fieldName, $options = array(), $tinyoptions = array(), $preset = null){ 
        ...
        return $this->Form->input($fieldName, $options) . $this->_build($fieldName, $tinyoptions) . "<br/>". $this->Form->button(__('Load Editor'),array( 'onclick'=>'javascript:setup();','type'=>'button','class'=>'tinybtn')); 
    } 
