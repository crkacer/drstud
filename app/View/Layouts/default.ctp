...
<html lang="<?php echo$configLanguage;?>" dir="<?php echo$dirType;?>">
  <head>
	...
	<?php
		...
		echo $this->Html->css('/design700/assets/css/jquery-anyslider');										   
...
<body>
    <div class="container">
		<div class="header">
            <!-- <button id="logOutBtn">Log Out--><?php echo $this->Html->link('<span class="fa fa-power-off"></span>&nbsp;'.__('Sign out'),array('controller' => 'Users', 'action' => 'logout'),array('escape' => false,'class'=>'logbtn'));?><!-- </button> -->
        ...
        <div class="row">
            ...
            <div class="nav">
                ...
                <div id="firstpane" class="menu_list"> 
                    ...
                    <div class="menu_body">
                         <ul>
                             <li><a href="/TypingPractices">Typing Practice</a></li>
                             <li><a href="/Phonics">Phonics</a></li>
                             <li><a href="/Vocabularies">Vocabulary</a></li>
                             <li><a href="/Grammars">Grammar</a></li>
                             <li><a href="/Readings">Reading</a></li>
                         </ul>
                    </div>
                    <div class="menu_head"><h2><i class="fa fa-list-alt" aria-hidden="true"></i><a href="/Exams">Test</a></h2></div>
    ...
    <?php 
	   ...
	   echo $this->Html->script('/design700/assets/scripts/jquery.easing.1.3');
	   echo $this->Html->script('/design700/assets/scripts/jquery.anyslider');
										   
    ?>
    <script>
   jQuery(function(){
        if(jQuery('.questions_div').length){
			jQuery('.questions_div').anyslider({
				easing: 'easeOutQuad',
				interval: 0,
				keyboard: false,
				showBullets : false,
...
<?php }elseif ($this->here == "/Users/login") { 
    ...
    <div class="container signin">
        ...
        <div id="win" class="signin">
            ...
            <?php echo $this->Session->flash();?>
				...
				<button type="submit" class="signin" id="signInBtn"  class="btn btn-success"><span class="glyphicon glyphicon-log-in"></span> <?php echo __('Sign In');?></button>
