...
<div class="panel">
    <div class="panel-heading">
        <div class="btn-group">			
			...
			<?php echo$this->Html->link(__('Upcoming Exam'),array('controller'=>'Exams','action'=>'Upcoming'),array('class'=>'btn btn-success'));?>
		...
		<div class="panel-heading">
			...
			<div class="table-responsive">
				<table class="table table-striped">
					...
					<tr>
					<?php echo$this->Function->showExamList("upcoming",$upcomingExam,$currency,$dateFormat,$frontExamPaid,$examExpiry);?>
					<?php }else{?>
					<tr>
