...
class ReadingsController extends AppController
{
    ...
    public function beforeFilter()
    {
		...
		$this->SubjectName="Reading";
        $this->limit=5;
    }
    public function index()
    {
		
		$vocahw = $this->Reading->ReadingPracticeQs->find('all', array('conditions' => array('ReadingPracticeQs.category' => "Homework",'Subject.subject_name' => "Reading")));
