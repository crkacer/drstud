...
class TypingPracticesController extends AppController
{
    ...
    public function beforeFilter()
    {
		...
		$this->SubjectName="TypingPractice";
        $this->limit=5;
    }
    public function index()
    {
		
		$vocahw = $this->TypingPractice->TypingPracticeQs->find('all', array('conditions' => array('TypingPracticeQs.category' => "Homework",'Subject.subject_name' => "TypingPractice")));
